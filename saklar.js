function saklar() {
    ...
    if(toggle2.checked) {
        lampu2.src = "assets/images/lampu_on.png" 
    }else {
        lampu2.src = "assets/images/lampu_off.png"
    }

    if(toggle3.checked) {
        lampu3.src = "assets/images/lampu_on.png" 
    }else {
        lampu3.src = "assets/images/lampu_off.png"
    }
    if(toggle4.checked) {
        lampu4.src = "assets/images/lampu_on.png" 
    }else {
        lampu4.src = "assets/images/lampu_off.png"
    }
    if(toggle5.checked) {
        lampu5.src = "assets/images/lampu_on.png" 
    }else {
        lampu5.src = "assets/images/lampu_off.png"
    }
    if(toggle6.checked) {
        lampu6.src = "assets/images/lampu_on.png" 
    }else {
        lampu6.src = "assets/images/lampu_off.png"
    }
    if(toggle7.checked) {
        lampu7.src = "assets/images/lampu_on.png" 
    }else {
        lampu7.src = "assets/images/lampu_off.png"
    }
    if(toggle8.checked) {
        lampu8.src = "assets/images/lampu_on.png" 
    }else {
        lampu8.src = "assets/images/lampu_off.png"
    }
    if(toggle9.checked) {
        lampu9.src = "assets/images/lampu_on.png" 
    }else {
        lampu9.src = "assets/images/lampu_off.png"
    }
    if(toggle10.checked) {
        lampu10.src = "assets/images/lampu_on.png" 
    }else {
        lampu10.src = "assets/images/lampu_off.png"
    }
